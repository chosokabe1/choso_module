...
def main(data_dir, model_list, input_size, batch_size, epochs, output_name, input_channels=3, out_save = True, last = True):
    ...
    with open('20230412-2.csv', 'w', newline="") as f: 
        ...
        for model in model_list:
            ...
            for id,data in enumerate(data_dir):
                val_acc_hist, _ = chosoai.train(data_dir=data,model_name=model,
                            output_name=  output_name + "_" + model+"-fold"+str(id+1),
                            num_classes=2,
                            batch_size = batch_size, num_epochs = epochs,
                            feature_extract = False, binary = (input_channels == 1), last = last, 
...
if __name__ == '__main__':
    resize_data_dir = [r"D:\ex\egg\data\jpeg\study_datasets\resize\fold1"]
